...
<body class="app">
          ...
          <div class="col-md-7">
            <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
              ...
              <div class="app-card-body px-4 w-100">
                <form method="POST" id="form-add-category" class="p-3">

                  <div class="form-group">
                    <label for="name">Name</label>
                    <input type="name" class="form-control" id="name" name="category_name">
                  </div>
  ...
  <script>
    $("#form-add-category").on("submit", function(e) {
      ...
      swal.showLoading()
      $.ajax({
        url: "<?= SERVER_NAME . "/backend/nodes?action=add_category" ?>",
        type: "POST",
