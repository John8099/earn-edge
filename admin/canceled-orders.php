...
<body class="app">
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
      <div class="container-xl">
        ...
        <div class="row g-3 mb-4 align-items-center justify-content-between">
          <div class="col-auto">
            <h1 class="app-page-title mb-0">Canceled Orders</h1>
          </div>
        </div><!--//row-->

        <div class="card">
          <div class="card-body">
            <table class="table app-table-hover mb-0 text-left" id="canceledOrdersTable">
              <thead>
                <tr>
                  ...
                  <th class="text-start">Date Canceled</th>
                  <th class="text-start">Action</th>
                </tr>
              </thead>
              <tbody>
                <?php
                $orders = $helpers->select_all_with_params("orders", "status='canceled'");
                ...
                ?>
                  <tr>
                    ...
                    <td style="vertical-align: middle" class="cell text-start"><a class="btn-sm btn btn-primary" href="<?= SERVER_NAME . "/admin/order-details?id=$order->id&&page=" . urlencode("Canceled Order Details") ?>">View</a></td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
  ...
  <script>
    const canceledOrdersTableCols = [0, 1, 2, 3, 4];
    const canceledOrdersTable = $("#canceledOrdersTable").DataTable({
      paging: true,
      lengthChange: true,
      ordering: false,
      info: true,
      ...
      buttons: [{
          ...
          title: '',
          exportOptions: {
            columns: canceledOrdersTableCols
          },
