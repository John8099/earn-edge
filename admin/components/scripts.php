<!-- Javascript -->
<script src="<?= SERVER_NAME . "/admin/assets/plugins/popper.min.js" ?>"></script>
<script src="<?= SERVER_NAME . "/admin/assets/plugins/bootstrap/js/bootstrap.min.js" ?>"></script>

<!-- Charts JS -->
<script src="<?= SERVER_NAME . "/admin/assets/plugins/chart.js/chart.min.js" ?>"></script>
<script src="<?= SERVER_NAME . "/admin/assets/js/index-charts.js" ?>"></script>

<!-- Page Specific JS -->
<script src="<?= SERVER_NAME . "/admin/assets/js/app.js" ?>"></script>
