...
<body class="app">
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
      <div class="container-xl">
        ...
        <div class="row g-3 mb-4 align-items-center justify-content-between">
          <div class="col-auto">
            <h1 class="app-page-title mb-0">Expired Orders</h1>
          </div>
        </div><!--//row-->

        <div class="card">
          <div class="card-body">
            <table class="table app-table-hover mb-0 text-left" id="expiredOrderTable">
              <thead>
                <tr>
              ...
              <tbody>
                <?php
                $orders = $helpers->select_all_with_params("orders", "status='expired'");
  ...
  <script>
    const expiredOrderTableCols = [0, 1, 2, 3];
    const expiredOrderTable = $("#expiredOrderTable").DataTable({
      paging: true,
      lengthChange: true,
      ordering: false,
      info: true,
